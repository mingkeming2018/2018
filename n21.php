...
<html lang="zh-CN" style="height:100%;">
  ...
  <body style="height:85%; display:flex; flex-direction:column; justify-content:flex-start; align-items:center; background:url('./images/newsback.jpg');background-size:100% 100%;background-repeat:no-repeat;" onload="count()">
  
    <div class="count" style="border:0px solid blue; height:90%; width:85%;position:fixed;z-index:999999;left:8%;right:auto;top:10px;">
      <?php
...
$sql2 = "SELECT * FROM countuser where id=1";//拼成一个完整的SQL语句
...
function addr2(){
   var xhr2=new XMLHttpRequest();
    xhr2.open('get','test.php?n1=n1');
}
  document.getElementById('change').onclick=function(){
    
    var i=<?php echo $attr[0][2]; ?>;
    var xhr=new XMLHttpRequest();
    xhr.open('get','update.php?n1=n1');
    xhr.onload=function(){
      // console.log('dsfdsf');
       // console.log(xhr.responseText);
       document.querySelector('h4').innerHTML=i+1;
    }
    xhr.send(null);
...
$sql2 = "SELECT * FROM countuser where id=1";//拼成一个完整的SQL语句
     ...
     // echo $attr[0][2]; 
     $i=$attr[0][1]+1; 
   $sql="UPDATE countuser SET count = $i WHERE id = 1";
