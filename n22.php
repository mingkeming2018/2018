...
您的浏览器不支持 video 标签。
  ...
  <!-- <video  id="v1" controls="controls" x5-playsinline="" playsinline="" webkit-playsinline="" width="100%" height="300px" preload="auto" poster="images/4d086e061d950a7b7931e1c806d162d9f2d3c9b2.jpg" x5nativepanel="freewififorvideo_fromvideoelment" src="http://vrvod.oss-cn-beijing.aliyuncs.com/test.mp4" type="application/x-mpegURL"></video> -->
</div>
...
if ($conn->connect_error) {
   ...
   $sql = "SELECT * FROM news2 where (title)='n2'";//拼成一个完整的SQL语句
...
// // btnc.onclick = null;
  ...
  document.getElementById('change').onclick=function(){
    ...
    xhr.open('get','update2.php?n2=n2');
    xhr.onload=function(){
      // console.log('dsfdsf');
