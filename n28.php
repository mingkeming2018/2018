...
您的浏览器不支持 video 标签。
  ...
  <video id="v8" controls="" x5-playsinline="" playsinline="" webkit-playsinline="" width="100%" height="300px" preload="auto" poster="" x5nativepanel="freewififorvideo_fromvideoelment" src="" type="application/x-mpegURL"></video>
</div>
...
if ($conn->connect_error) {
   ...
   $sql = "SELECT * FROM news2 where (title)='n8'";//拼成一个完整的SQL语句
...
var m=0;
  document.getElementById('change').onclick=function(){
    ...
    xhr.open('get','update8.php?n8=n8');
    xhr.onload=function(){
      // console.log('dsfdsf');
